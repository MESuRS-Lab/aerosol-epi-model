...
adm_data$type <- factor(adm_data$type, levels = c("Medical", "Paramedical", "Patient", "Other"))
...
ggsave(file.path(wd, "..", "..", "out", "fig1-nodscov2-RP-ICU.png"), height = 12, width = 10)
```
