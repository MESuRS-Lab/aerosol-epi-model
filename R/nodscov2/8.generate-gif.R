...
rooms <- rooms %>%
  ...
  mutate(room = ifelse(id_room<50, paste("Patient Room", room), room)) %>%
...
rooms_coords <- rooms %>%
  mutate(
    x = case_when(
      ...
      room == "Patient Room 5" ~ 8,
      room == "Patient Room 6" ~ 4,
      room == "Patient Room 7" ~ 5,
      room == "Patient Room 8" ~ 6,
      room == "Patient Room 9" ~ 7,
      room == "Patient Room 10" ~ 8,
      room == "Patient Room 11" ~ 4,
      room == "Patient Room 12" ~ 5,
      room == "Patient Room 13" ~ 6,
      room == "Patient Room 14" ~ 7,
      room == "Patient Room 15" ~ 8,
      room == "Patient Room 16" ~ 4,
      room == "Patient Room 17" ~ 5,
      room == "Corridor" ~ 1.75
    ),
    y = case_when(
      ...
      room == "Patient Room 14" ~ 2.5,
      room == "Patient Room 15" ~ 2.5,
