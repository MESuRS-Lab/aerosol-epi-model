...
t = 659
t_room = 11
res_status %>% filter(inf_room == t_room)
t_id = "001-0001-D-J"
res_status %>% filter(id == t_id)
sourceCpp(file.path(cpp_model_path,"model_nodscov2.cpp"))

List_inf_encountered(t_id, global_interaction[[t]], res_status, admission_test, t)

test_vector = c()
list_check = c()
for (id_test in List_encountered(t_id, global_interaction[[t]])){
  Get_status_j("001-0030-N-H", res_status, admission_test, t)
