...
load(file.path("..", "..", "out", "scenarios-analysis", "parameters-admission-nodscov2.RData"))
source("scenarios-analysis-supp.R")
sourceCpp(file.path("..", "..", "cpp", "nodscov2", "dev-sensibility-analysis.cpp"))

## Transmission parameters 
beta_c <- 3/4
beta_e <- 3600*24/30
nu <- 12
env_model = "log-linear" # linear exponential log-linear
env_threshold = 10
...
compute_SEIR(result, 90*24*60*2) %>%
