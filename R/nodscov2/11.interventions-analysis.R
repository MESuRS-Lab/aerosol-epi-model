...
ggplot(median_interventions, aes(x = Scheme, y = estimate, ymin = conf.high, ymax = conf.low, fill = Category)) +
...
ggsave("fig/paper/figure5.eps", height = 12, width = 11)
...
# Plot
ggplot(pairs_interventions, aes(x = Scheme, y = estimate, fill = intervention)) +
