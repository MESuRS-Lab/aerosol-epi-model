...
for (f in list.files(file.path(synthetic_path, "test"), pattern = "matContact", full.names = T)) {
...
for (f in list.files(file.path(synthetic_path, "full"), "matContactBuilt", full.names = T)) {
 data = read.csv2(f)
...
simu_files = list.files(path = file.path(synthetic_path, "full"), pattern = "matContact.*", full.names = T)
