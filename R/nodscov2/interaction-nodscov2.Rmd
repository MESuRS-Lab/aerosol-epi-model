...
# Adjusted cumulative time interacting with patients by category of HCW
ggplot(sum_length_cat, aes(x = id_pe, y = adj_sum_cat)) +
  geom_bar(stat = "identity") +
  theme_bw() +
  #theme(axis.text.x = element_text(angle = 35, hjust = 1)) +
  ...
  labs(
    title = "Distribution of adjusted time spent interacting with patients by category of HCW",
    x = "Category",
    y = "Adjusted cumulative time interacting"
  )

# Number of distinct interactions with patients by category of HCW
ggplot(sum_length_cat, aes(x = id_pe, y = n_cat)) +
  geom_bar(stat = "identity") +
  theme_bw() +
  #theme(axis.text.x = element_text(angle = 35, hjust = 1)) +
  theme(axis.text.x = element_blank()) +
  facet_grid(cols = vars(cat)) +
  labs(
    title = "Distribution of distinct interactions with patients by category of HCW",
    x = "Category",
    y = "Number of interactions"
  )

# Cumulative time spent interacting with patients by category of HCW
ggplot(sum_length_cat, aes(x = id_pe, y = sum_cat)) +
  geom_bar(stat = "identity") +
  theme_bw() +
  #theme(axis.text.x = element_text(angle = 35, hjust = 1)) +
  theme(axis.text.x = element_blank()) +
  facet_grid(cols = vars(cat)) +
  labs(
    title = "Distribution of time spent interacting with patients by category of HCW",
    x = "HCW ID",
    y = "Cumulative time interacting"
  )
```
...
# Plot
sum_length_cat %>%
  ggplot( aes(x=cat, y=sum_cat, fill=cat)) +
    geom_boxplot() +
