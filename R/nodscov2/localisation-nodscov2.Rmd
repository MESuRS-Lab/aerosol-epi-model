...
global_localisation <- lapply(1:n_subdivisions, function(t) {
  ...
  lapply(clusters_t, function(cluster) {
    ...
    # IF THERE IS MULTIPLE PATIENTS IN THE CLUSTER --> TEMPORARY , FIXED LATER
    ...
    # Check if there is ONLY ONE PATIENT in the cluster
...
## LOCALISATION INFERENCE ACCORDING TO 
```{r}
