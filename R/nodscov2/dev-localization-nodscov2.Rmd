...
rooms <- rooms %>%
  ...
  bind_rows(data.frame(room = "Paramedical Restroom", id = "R-PM-PE", id_room = as.factor(nrow(rooms) + 1))) %>%
  bind_rows(data.frame(room = "Nursing station", id = "PM-PE", id_room = as.factor(nrow(rooms) + 1))) %>%
  bind_rows(data.frame(room = "Office", id = "M-PE", id_room = as.factor(nrow(rooms) + 1))) %>%
