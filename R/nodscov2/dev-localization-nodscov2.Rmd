...
p_number_int <- do.call(rbind, global_interaction) %>%
  ...
  ggplot(aes(x=begin_date + time*30, y=n, color = type_int))+
    geom_line() +
    annotate("rect", xmin = as.POSIXct("2020-05-06 22:00:00"), xmax = as.POSIXct("2020-05-07 06:00:00"), ymin = -Inf, ymax = Inf, alpha = 0.2, fill = "grey") +
    theme_bw() +
...
ggsave(file = file.path(fig_path, paste0("p_number_int", ".png")), plot = p_number_int, height = 10, width = 30)
