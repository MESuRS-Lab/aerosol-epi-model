...
```{r}
global_interaction <- lapply(global_interaction, function(df) {
...
#SAVE TO .RData FILES
```{r}
save(clusters, global_localization, inferred_admission, rooms, global_interaction, admission, HCW_interacting_ids, n_subdivisions, begin_date, end_date, file = file.path(loc_nodscov2_path, "localization-nodscov2.RData"))
```
