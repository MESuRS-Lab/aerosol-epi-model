...
print(paste0("Temps d'execution d'une subdivision : ",substr(b-a, 1, 7),"s"))
print(paste0("Temps d'execution de la récupération des interactions : ",substr(t2_int - t1_int, 1, 7),"s"))
print(paste0("Temps d'execution de la mise à jour des localisations  : ",substr(t2_loc - t1_loc,1 , 7),"s"))
print(paste0("Temps d'execution de la mise à jour de l'environnement  : ",substr(t2_env - t1_env, 1, 7),"s"))
print(paste0("Temps d'execution de la mise à jour des statuts d'infection  : ",substr(t2_status - t1_status, 1, 7),"s"))
